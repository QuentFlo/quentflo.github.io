...
### 1. Boutique de jeux vidéo en ligne

Voici une boutique en ligne de jeux vidéo réalisée avec Flutter. Vous pouvez consulter le code source et les détails sur [GitHub](https://github.com/QuentFlo/Flutter-Shop).

![Image 1](https://github.com/user-attachments/assets/5685338d-df0b-495b-b7ea-dbecc370b0ce)
![Image 2](https://github.com/user-attachments/assets/d14f9441-32af-4a85-b7af-5cb1bd1c121a)  
![Image 3](https://github.com/user-attachments/assets/fcc3bdbd-9bd5-472f-81c9-94e8a3f09405)
![Image 4](https://github.com/user-attachments/assets/e95b89b0-7fa1-42cd-bd7c-c219cb15561e)  
![Image 5](https://github.com/user-attachments/assets/fb4be136-8a12-46a3-b399-4d0678bb0cd7)

---

### 2. Application mobile de gestion de tâches (React Native)

Une application mobile en React Native permettant de gérer une liste de tâches. Retrouvez le projet sur [GitHub](https://github.com/QuentFlo/RNativeApp).

![Image de l'app](https://user-images.githubusercontent.com/72348896/150975055-264799e8-c52d-4c7b-a20d-cc0e97b5cf86.jpg)

---

### 3. Agenda Multi-Profils

Une application permettant de gérer un agenda sous trois profils différents : Administrateur, Professeur, et Étudiant. 

- **Professeurs** : ajoutent des devoirs à la date souhaitée et peuvent les partager avec les élèves.
- **Étudiants** : consultent les devoirs et téléchargent les documents associés.
- **Administrateurs** : gèrent les données des utilisateurs (ajout/suppression de professeurs et étudiants).

Le projet est disponible sur [GitHub](https://github.com/QuentFlo/Agenda).
...
- Reconnaître les poissons du lagon
- Offrir un outil de travail pour les professionnels du milieu marin
- Fournir une expérience ludique pour les passionnés
